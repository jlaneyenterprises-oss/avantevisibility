...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/avante-visibility",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61577552439813",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current" aria-hidden="true">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/avantevisibility",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current" aria-hidden="true">
  ...
  {
    name: "X",
    href: "https://x.com/AvanteVisible",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current" aria-hidden="true">
